...
//old green detection
#define TOL 50 //Creates the value of tolerance for the green values
...
#define SILVER_RR 759
#define SILVER_RL 636

#define SILVER_GR 859
#define SILVER_GL 788

#define SILVER_BR 715
#define SILVER_BL 548
...
#define DEPL 140 //deposit left
#define DEPR 20 //deposit right
#define OPENL 40 //opens for left
...
bool paredes[12], ent_m=0, precaution=0;
...
void loop() 
{
  ...
  //  Serial.println(getUltra(2));
  //  Serial.println(getUltra(3));
  ...
  //  SwallowBalls();
    ...
    // Serial.println(digitalRead(TOUCH2));x
