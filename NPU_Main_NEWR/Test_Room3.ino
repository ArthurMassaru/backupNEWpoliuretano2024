...
{  //function used to scan entrance
  ...
  {
    exit_angle = 1023;
    if((ent_s == 1 && media_vl <= 90.0 && media_vt <= 90.0) || (ent_s == -1 && media_vr <= 90.0 && media_vt <= 90.0))rooms = 90;
    else 
    { 
      if(media_vt <= 90.0)rooms = 1201;
      else rooms = 120;
    }
